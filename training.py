...
def makeCsv(data, path=os.getcwd()):
    cvpath = os.path.join(path, "neuralNetResults/simple/dataset.csv")
    sfPath = os.path.join(path, "neuralNetResults/simple/datasetSF.csv")
...
if __name__ == "__main__":
    ...
    nn.save()
    white = neuralPLayer("Lisa", WHITE, nn)
